...
Kittygram - это уникальная платформа, которая позволит вам:

- добавлять, редактировать и просматривать котов;
- присваивать им достижкния;
- просматривать питомев других пользователей.

### Инструкция по запуску проекта:

**1. Клонируйте репозиторий и перейдите в него в командной строке:**
```
git clone git@github.com:Apollo297/kittygram_final.git
```
